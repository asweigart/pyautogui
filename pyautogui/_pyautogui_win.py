...
def _keyDown(key):
    ...
    if key in keyboardMapping.keys():
        ...
        # note: I could use this case to update keyboardMapping to cache the VkKeyScan results,
        # but I've decided not to just to make any possible bugs easier to reproduce.
...
def _sendMouseEvent(ev, x, y, dwData=0):
    ...
    # TODO: ARG! For some reason, SendInput isn't working for mouse events.
    ...
    # according to https://stackoverflow.com/questions/13564851/generate-keyboard-events
    # I can just set this. I don't really care about this value.
    # mouseStruct.dwExtraInfo = ctypes.pointer(ctypes.c_ulong(0))
    # inputStruct = INPUT()
