...
keyboardMapping.update({
    ...
    'launchapp1':        _display.keysym_to_keycode(Xlib.XK.string_to_keysym('XF86_Launch1')),
    'launchapp2':        _display.keysym_to_keycode(Xlib.XK.string_to_keysym('XF86_Launch2')),
